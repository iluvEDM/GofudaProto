 ...
 * must implement the {@link ClientFragment.OnFragmentInteractionListener}
 * interface to handle interaction events. Use the
 * {@link ClientFragment#newInstance} factory method to create an instance of
 * this fragment.
 *
 */
public class ClientFragment extends Fragment implements OnClickListener{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mMenuFragment = new ClientMenuFragment();
...
//		}
	...
	public void onClick(View v) {
		...
		case R.id.bt_menu:
			getActivity().getSupportFragmentManager().beginTransaction()
			.replace(R.id.client_container, mMenuFragment).commit();
			break;
		case R.id.bt_review:
			getActivity().getSupportFragmentManager().beginTransaction()
